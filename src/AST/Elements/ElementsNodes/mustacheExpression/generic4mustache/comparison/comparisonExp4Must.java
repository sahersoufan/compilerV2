...
public class comparisonExp4Must {
    ...
    public void setMustacheComparisonOperator(AST.Elements.ElementsNodes.mustacheExpression.generic4mustache.comparison.mustacheComparisonOperator mustacheComparisonOperator) {
    ...
    public AST.Elements.ElementsNodes.mustacheExpression.generic4mustache.comparison.mustacheComparisonOperator getMustacheComparisonOperator() {
