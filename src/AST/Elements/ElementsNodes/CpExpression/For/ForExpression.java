...
public class ForExpression {
    ...
    public void setCollection4For4(List<Collection4For4> collection4For4) {
        this.collection4For4 = collection4For4;
    }



    public void setCollection4For1(Collection4For1 collection4For1) {
    ...
    public void setCollection4For3(Collection4For3 collection4For3) {
        this.collection4For3 = collection4For3;
    }


    public void setCollection4For5(Collection4For5 collection4For5) {
        this.collection4For5 = collection4For5;
    }



    public Collection4For1 getCollection4For1() {
    ...
    public Collection4For5 getCollection4For5() {
        return collection4For5;
    }
